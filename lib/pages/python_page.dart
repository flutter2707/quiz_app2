...
class _PythonPageState extends State<PythonPage> {
  ...
  void initState() {
    ...
    python = hiveRep.getResultPy();
    pythonTime = hiveRep.getTimePy();
    ...
    return SafeArea(
      child: Scaffold(
          ...
          body: Stack(children: [
            ...
            Padding(
              padding: const EdgeInsets.only(top: 528, left: 50),
              child: Container(
                  height: 55,
                  width: 316,
                  decoration: BoxDecoration(
            ...
            Padding(
              padding: const EdgeInsets.only(top: 603, left: 50),
              child: Container(
                  height: 55,
                  width: 316,
                  decoration: BoxDecoration(
                ...
                child: MaterialButton(
                    onPressed: () {
                      ...
                      setState(() {
                        ...
                        python.add('$score/${list.length}');
                        hiveRep.saveResultPy(python);
                        String now = dateTimes();
                        pythonTime.add(now);
                        hiveRep.saveTimePy(pythonTime);
